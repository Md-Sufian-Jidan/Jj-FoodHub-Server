...
export const providerMealService = {
    createMeal: async (providerId: string, data: MealData) => {
    ...
    updateMeal: async (providerId: string, mealId: string, data: Partial<MealData>) => {
    ...
    getProviderMeals: async (providerId: string) => {
