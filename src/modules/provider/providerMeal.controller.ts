...
const updateMeal = async (req: Request, res: Response) => {
    try {
        ...
        const mealData = req.body;
        const updatedMeal = await providerMealService.updateMeal(providerId, mealId as string, mealData);
...
const deleteMeal = async (req: Request, res: Response) => {
    try {
        const providerId = req.user!.id;
        const { id: mealId } = req.params;
        const result = await providerMealService.deleteMeal(providerId, mealId as string);
